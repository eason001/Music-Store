package cs636.music.presentation.clientserver;
...
import cs636.music.presentation.*;
...
public class AdminApp {
	...
	public static void main(String[] args) {
		try {
			...
			e.printStackTrace();
			System.err.println("Error in run, shorter report: "
	...
	public void processInvoice() throws IOException, ServiceException {
		...
		while (true) {
			...
			Set<Invoice> invoices = adminService.getListofUnprocessedInvoices();
			if (invoices.isEmpty()) {
